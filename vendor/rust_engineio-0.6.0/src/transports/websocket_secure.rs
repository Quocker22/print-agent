...
impl WebsocketSecureTransport {
    ...
    pub fn new(
        ...
        // print-agent (vá cục bộ, xem VA-CUC-BO.md): TCP + TLS + nâng cấp websocket có hạn.
        let inner = runtime.block_on(async {
            tokio::time::timeout(
                crate::HAN_DUNG_KET_NOI,
                AsyncWebsocketSecureTransport::new(base_url, tls_config, headers),
            )
            .await
